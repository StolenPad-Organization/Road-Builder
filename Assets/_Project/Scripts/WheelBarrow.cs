...
public class WheelBarrow : MonoBehaviour
{
    ...
    public void OnCollect(Collectable collectable)
    {
        ...
        GameManager.instance.AddCollectableData(false, collectable.collectableType, collectable.peelable);
    }
    public void SellCollectable(Transform sellPoint)
    {
        ...
        GameManager.instance.RemoveCollectableData(false, collectable.collectableType, collectable.peelable);
    }
